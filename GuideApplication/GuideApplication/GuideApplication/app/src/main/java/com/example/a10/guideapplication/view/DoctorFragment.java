...
public class DoctorFragment extends Fragment implements PlaceInterface, DoctorInterface{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchEditText.setQueryHint("ابحث عن طبيب");
        placeInterface = this;
        ...
        searchEditText.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                presenter.search(getString(R.string.doctor), s);
                return true;
            }
        ...
        if (doctors!=null){
            DoctorsAdapter adapter = new DoctorsAdapter(doctors, getString(R.string.doctor));
        ...
        if (topRatedDoctors != null) {
            DoctorsAdapter adapter2 = new DoctorsAdapter(topRatedDoctors, getString(R.string.doctor));
            ...
            presenter.topRated(getString(R.string.doctor));
        }
        return view;
    }
    ...
    public void doctors(List<Doctor> doctors) {
        ...
        if (doctors != null && doctors.size() > 0) {
            ...
            placesNotFoundTV.setText("لا يوجد اطباء لعرضهم");
        }
    }
    ...
    public void topRated(List sections) {
        if (sections != null && sections.size() > 0) {
            this.topRatedDoctors = sections;
            DoctorsAdapter adapter = new DoctorsAdapter(sections, getString(R.string.doctor));
            ...
            topRatedNotFoundTV.setText("لا يوجد اطباء لعرضهم");
        }
    }
    ...
    public void searchDoctor(List<Doctor> doctor) {
        if (doctor!=null && doctor.size()>0){
            ...
            SearchDoctorAdapter adapter = new SearchDoctorAdapter(doctor, getString(R.string.doctor));
