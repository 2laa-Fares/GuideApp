...
public class BranchesFragment extends Fragment implements BranchInterface{
    ...
    public void branches(List<Branch> branches) {
        if (branches!=null){
            ...
            if(userCanEdit == false) adapter = new BranchesAdapter(branches, placeImage, placeType, null);
            else adapter = new BranchesAdapter(branches, placeImage, placeType, presenter);
