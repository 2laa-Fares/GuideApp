...
public class CoffeesFragment extends Fragment implements PlaceInterface{
    ...
    List<Section> coffees;
    List<Section> topRatedCoffees;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        if (coffees!=null){
            PlaceAdapter adapter = new PlaceAdapter(coffees);
            ...
            progressBar.show();
            presenter.getPlaces(getString(R.string.coffee));
        }
        if (topRatedCoffees != null) {
            PlaceAdapter adapter2 = new PlaceAdapter(topRatedCoffees);
            ...
            presenter.topRated(getString(R.string.coffee));
        }
        return view;
    }
    ...
    public void places(List<Section> sections) {
        ...
        if (sections != null && sections.size() > 0) {
            ...
            placesNotFoundTV.setText("لا يوجد مطاعم او مقاهى لعرضها");
        }
    }
    ...
    public void topRated(List sections) {
        if (sections != null && sections.size() > 0) {
            ...
            topRatedNotFoundTV.setText("لا يوجد مطاعم او مقاهى لعرضها");
        }
