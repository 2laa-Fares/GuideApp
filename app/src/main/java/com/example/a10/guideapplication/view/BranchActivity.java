...
public class BranchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle branchAddressBundle = new Bundle();
        branchAddressBundle.putString(getString(R.string.branchContact), branch.getContact());
        branchAddressBundle.putString(getString(R.string.branchAddress), branch.getAddress());
        branchAddressBundle.putDouble(getString(R.string.latitude), branch.getLocationX());
        branchAddressBundle.putDouble(getString(R.string.longitude), branch.getLocationY());
        branchAddressFragment.setArguments(branchAddressBundle);
        if(placeType.equals(getString(R.string.hotel))){
            ...
            bundle1.putBoolean(getString(R.string.edit), getIntent().getBooleanExtra(getString(R.string.edit), false));
